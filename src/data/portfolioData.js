export const PORTFOLIO_DATA = {
  ...
  skills: [
    { name: "TypeScript", category: "Languages", icon: "FileCode", level: "Expert", featured: true },
    { name: "Node.js / Express", category: "Languages", icon: "Server", level: "Expert", featured: true },
    { name: "PostgreSQL", category: "Databases", icon: "Database", level: "Expert", featured: true },
    { name: "Redis", category: "Databases", icon: "Zap", level: "Expert", featured: true },
    { name: "Scalar & OpenAPI 3.0", category: "API & Messaging", icon: "Globe", level: "Expert", featured: true },
    { name: "WebSockets & Socket.io", category: "API & Messaging", icon: "MessageSquare", level: "Expert", featured: true },
    { name: "Go (Golang)", category: "Languages", icon: "Code", level: "Advanced", featured: true },
    { name: "Python / FastAPI", category: "Languages", icon: "Terminal", level: "Advanced", featured: false },
    { name: "ClickHouse", category: "Databases", icon: "HardDrive", level: "Intermediate", featured: false },
    { name: "MongoDB", category: "Databases", icon: "Database", level: "Advanced", featured: false },
    { name: "Apache Kafka", category: "API & Messaging", icon: "Layers", level: "Advanced", featured: true },
    { name: "RabbitMQ", category: "API & Messaging", icon: "MessageSquare", level: "Advanced", featured: false },
    { name: "gRPC & Protocol Buffers", category: "API & Messaging", icon: "Cpu", level: "Intermediate", featured: false },
    { name: "Docker & Containerization", category: "Cloud & DevOps", icon: "Box", level: "Expert", featured: true },
    { name: "Kubernetes (k8s)", category: "Cloud & DevOps", icon: "Cloud", level: "Intermediate", featured: false },
    { name: "AWS (S3, EC2, Lambda)", category: "Cloud & DevOps", icon: "CloudRain", level: "Advanced", featured: true },
    { name: "CI/CD (GitHub Actions)", category: "Cloud & DevOps", icon: "GitBranch", level: "Advanced", featured: false }
  ],
